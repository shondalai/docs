...
2. Navigate to the translation or language settings for the form or a specific field.
3. Use an **AI Translate** button or option (if available) to generate translations of labels and messages.
4. Review and adjust translations for accuracy and tone.
...
1. Switch your site’s language from the frontend (using a language switcher module).
2. Visit the pages containing your forms.
3. Confirm that:
...
- [AI Form Builder Assistant](./ai-form-builder)
- [Publishing Forms on Your Site](./publishing-forms)
