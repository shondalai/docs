...
3. Click **New**.
4. Enter a **Form Title** (e.g., "Contact Us", "Event Registration").
5. Optionally choose a **Form Type** (form, survey, quiz, poll) if available.
6. Click **Save** to create the form, then open the **Form Builder** tab.
...
1. In the **Field sidebar**, browse available field types:
...
2. Drag a field into the form preview or click it to add it at the bottom.
...
1. Add **Section** or **Heading** fields to visually separate parts of the form.
2. Use clear titles like "Personal Information" or "Preferences".
...
1. Click **Preview** in the builder toolbar.
2. A preview opens (often in a new tab).
3. Test your form as a visitor would:
...
Read the dedicated guide: [AI Form Builder Assistant](./ai-form-builder).
...
- Configure **confirmation and notification emails** – see [Email Notifications and Autoresponders](./emails).
- Add **conditional logic** to show/hide fields dynamically – see [Conditional Logic and Smart Forms](./conditional-logic).
- **Publish** your form on your site – see [Publishing Forms on Your Site](./publishing-forms).
