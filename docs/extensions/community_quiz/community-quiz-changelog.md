...
### 🐛 Fixed
- Use details tab as first tab on course builder
- Add missing trash button on courses

## [8.2.2] - 2026-09-02

### 🐛 Fixed
- Toolbar buttons are not showing in question banks page

## [8.2.1] - 2026-09-01

### 🚀 Added
- Adding Joomla Quiz Delux migration support
...
### 🐛 Fixed
- Builder is not showing editor when using JCE editor

## [8.1.6] - 2026-08-20

### 🐛 Fixed
- Blank page shows when editing question
- Adding missing menu language strings

## [8.1.5] - 2026-08-16

### 🐛 Fixed
- Question builder editors are too restrictive in allowing HTML content
...
### 🚀 Added
- Move permissions button to settings page and remove toolbar
- Add pagination to the questions selector from bank in the quiz builder

## [8.1.2] - 2026-08-09

### 🐛 Fixed
- License shows as not connected after activation
...
### 🐛 Fixed
- Resolved issue with displaying reports for question banks quiz
