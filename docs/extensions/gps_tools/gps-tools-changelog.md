...
### 🐛 Fixed
- Applied elevation smoothing when uploading files
- Prevented automatic track publishing when moderation is enabled

## [7.0.15] - 2026-03-27

### 🐛 Fixed
- Published track automatically even when moderation was enabled
