...
### 🚀 Added
- Add support for module positions
...
### 🐛 Fixed
- Fixed untranslated strings in pulse template

## [6.4.2] - 2026-09-18

### 🚀 Added
- Move layout manager to classic template settings

### 🐛 Fixed
- Minor UX issues fixed
...
### 🐛 Fixed
- Fixes for admin dashboard mobile responsiveness
- Classic template sidebar blocks are not responsive
- Forum header in classic templete is overlapping Joomla menu

## [6.2.10] - 2026-08-18

### 🐛 Fixed
- Unauthorised users should not see empty gallery items
- The gallery images are not rendered in full height
- Long words in title should wrap in title cards
- Adapt Joomla editor for dark mode
...
### 🐛 Fixed
- Fixed editor not displaying after toggling and reloading the page
- Fixed replies missing title in smart search plugin results

## [6.2.5] - 2026-07-18

### 🚀 Added
- Added new broadsheet template
- Added show trending topics button on the toolbar

### 🐛 Fixed
- Fixed issue with top posters block showing incorrect list
- Aligned the sidebar on topic page with topic card in Pulse template
- Fixed issue preventing forum title change in the header

## [6.2.4] - 2026-07-16

### 🐛 Fixed
- Hardened media folder access and backend services

## [6.2.3] - 2026-07-16

### 🐛 Fixed
- Topic content appeared on reply form after editing the topic
...
- Added Rewardify integration
- Added new Community and Ledger site templates
- Introduced site templates support with additional templates
- Introduced single page app (SPA) experience on frontend
- Redesigned admin interface with React SPA
...
### 🐛 Fixed
- Unable to load editor on reply form (intermittent)
...
### 🐛 Fixed
- Fixed username display issue in notifications page
...
### 🐛 Fixed
- Fixed issue preventing topic deletion from frontend
- Fixed error displayed when editing topic

## [6.1.3] - 2026-03-24

### 🚀 Added
- Enabled global email notifications toggle
- Improved email templates manager user experience
- Supported sorting topics by last replied date

## [6.1.2] - 2026-03-22

### 🐛 Fixed
- Corrected the modified date column type in update SQL files
- Displayed bullet points in topic and reply descriptions

## [6.1.1] - 2026-03-12

### 🐛 Fixed
- Resolved error when clicking topics tab on profile page
- Fixed issue preventing topic editing
