...
### 🚀 Added
- Added dropdown progress type to switch between pages

### 🐛 Fixed
- Fixed survey field styles in dark mode
- Blocked uninstall of dependencies if other extensions used them
- Fixed inability to reconnect Google Sheets or Slack adapters
...
### 🚀 Added
- Added an option to hide public surveys from the survey listing page
- Added an option to display surveys in full screen mode

### 🐛 Fixed
- Fixed image choice questions not displaying images correctly
- Saved the date field only after user left the field
- Fixed issue preventing hiding TOC on a running survey
...
### 🚀 Added
- Enhanced multislider question type with options
...
### 🚀 Added
- Thanks page settings UX spacing is improved

### 🐛 Fixed
- Survey description and end text fields are not showing
- Likert questions do not render their scale and accept answers.
- The responses count is not updated when deleting responses
- Breadcrumbs in the survey builder shows previous survey title
...
### 🐛 Fixed
- Unable to load survey for public users with anonymous set to false
